            ...
            <div className=" flex flex-row gap-4">
                <div className="flex flex-col gap-4 flex-grow">
                    ...
                    <div className="flex flex-row">
                        ...
                        <form action="">
                            <input type="text" placeholder="search..." name="q" className="bg-background border border-transparent outline-none caret-foreground text-foreground h-full w-56 rounded-full px-4 py-2 focus:border-foreground-highlight hover:bg-background-very-dark transition-all" onChange={inputHandler}>
                            </input>
                        </form>
                    </div>
                    {(() => {
