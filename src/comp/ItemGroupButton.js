...
function ItemGroupButton(props) {
    return (
        <div>
            ...
            <label htmlFor={props.name} className="px-4 py-2 flex flex-row items-center bg-background gap-4 backdrop-blur-md peer-checked:border-foreground-highlight peer-checked:text-foreground-highlight hover:bg-background-very-dark hover:text-foreground transition-all border border-transparent cursor-pointer rounded-full text-[#FFFFFFAA]">
