...
function ItemGroupButton(props) {
    return (
        <div>
            ...
            <label htmlFor={props.name} className="px-4 py-2 flex flex-row items-center bg-background gap-4 backdrop-blur-md peer-checked:border-foreground-highlight peer-checked:text-foreground-highlight hover:bg-current-line hover:text-foreground transition-all border border-current-line cursor-pointer text-[#FFFFFFAA]">
